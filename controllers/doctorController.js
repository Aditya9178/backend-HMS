...
// This helps in sorting time slots chronologically
...
// Parse schedule input which can be a JSON string or an object, and ensure it's deduped and sorted
...
export const getDoctors = async (req, res) => {
  try {
    ...
    const total = await Doctor.countDocuments(match);//total numbers of doctors in DB.
...
export async function updateDoctor(req, res) {
  try {
    ...
    delete out.password;
    return res.json({ success: true, data: out });// return the updated doctor data in response
  } catch (err) {
