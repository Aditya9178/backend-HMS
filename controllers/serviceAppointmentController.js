...
export const confirmServicePayment = async (req, res) => {
  try {
    ...
    console.error("confirmServicePaymentError:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
}
...
export const getServiceAppointments = async (req, res) => {
  try {
    ...
    console.error("getServiceAppointmentsError:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
}

//to getServiceAppointmentBy Id..
export const getServiceAppointmentById = async (req, res) => {
  try {
    ...
    console.error("getServiceAppointmentByIdError:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
}
...
export const updateServiceAppointment = async (req, res) => {
  try {
    ...
    console.error("updateServiceAppointmentError:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
}
...
export const getServiceAppointmentStats = async (req, res) => {
  try {
    ...
    console.error("getServiceAppointmentStatsError:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
}
...
export const getServiceAppointmentsByPatient = async (req, res) => {
  try {
    ...
    console.error("getServiceAppointmentsByPatientError:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
}
